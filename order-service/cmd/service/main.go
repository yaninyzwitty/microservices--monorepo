...
import (
	...
	"github.com/yaninyzwitty/eccomerce-microservices-backend/order-service/controller"
...
func main() {
	...
	grpcAddress := fmt.Sprintf(":%d", cfg.OrderServer.Port)
	...
	orderController := controller.NewOrderController(pool)
	...
	slog.Info("Starting gRPC server", "port", cfg.OrderServer.Port)

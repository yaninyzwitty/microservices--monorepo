...
import (
	...
	"github.com/yaninyzwitty/eccomerce-microservices-backend/user-service/controller"
...
func main() {
	...
	grpcAddress := fmt.Sprintf(":%d", cfg.UserServer.Port)
	...
	userController := controller.NewUserController(pool)
	...
	slog.Info("Starting gRPC server", "port", cfg.UserServer.Port)
